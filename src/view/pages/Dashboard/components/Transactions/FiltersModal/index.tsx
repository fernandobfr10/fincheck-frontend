...
export function FiltersModal({ open, onClose }: FiltersModalProps) {
  ...
  return (
    <Modal open={open} title="Filtros" onClose={onClose}>
      <div>
        <span className="text-gray-800 text-lg font-bold tracking-[-1px]">
          Conta
        </span>
        ...
        <div className="space-y-2 mt-2">
          {mockedAccounts.map((account) => (
            <button
              ...
              className={cn(
                "w-full p-2 rounded-2xl text-left text-gray-800 hover:bg-gray-50 transition-colors",
      ...
      <div className="mt-10 text-gray-800">
        ...
        <div className="w-52 mt-2 flex items-center justify-between">
          <button
