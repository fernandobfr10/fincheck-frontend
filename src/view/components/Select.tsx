    ...
    <div>
      <div className="relative">
        ...
        <RdxSelect.Root onValueChange={handleSelect}>
          <RdxSelect.Trigger
            className={cn(
              `w-full bg-white rounded-lg border border-gray-500 px-3 h-[52px] text-gray-800
            ...
            <RdxSelect.Content className="z-[99] overflow-hidden bg-white rounded-2xl border-gray-100 shadow-[0px_11px_20px_0px_rgba(0,0,0,0.10)]">
              ...
              <RdxSelect.Viewport className="p-2">
                {options.map((option) => (
                  <RdxSelect.Item
                    key={option.value}
                    className="p-2 text-sm text-gray-800 data-[state=checked]:font-bold data-[highlighted]:bg-gray-50 outline-none rounded-lg transition-colors"
                    value={option.value}
                  >
